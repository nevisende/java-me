...
## This program helps you calculate the average grades for math, physics, chemistry, Turkish, history, and music lessons. Also, it shows the result of success in the end.
### On terminal:
![An Screenshot of the example of the program](./ss-example.png)
### Requirements:
